...
#         janela.blit(numero_1, (posicao_x[i], posicao_y[i])
...
# nave_player = pygame.image.load(
#     "C:/Users/diego/PycharmProjects/PythonProject/Jogos Pygame/Jogo de Aprendizado/Assets/sprite_nave_pequena.png")
