                ...
                if posicao_click_x > 140 and posicao_click_x < 210:
                    if events.type == pygame.KEYDOWN:
                        if events.key == pygame.K_1:
                            ...
                            pressionado = False
                if posicao_click_x > 210 and posicao_click_x < 270:
                    if events.type == pygame.KEYDOWN:
                        if events.key == pygame.K_1:
                ...
                if posicao_click_x > 480 and posicao_click_x < 550:
                    if events.type == pygame.KEYDOWN:
                        if events.key == pygame.K_1:
                            ...
                            pressionado = False
                if posicao_click_x > 550 and posicao_click_x < 620:
                    if events.type == pygame.KEYDOWN:
                        if events.key == pygame.K_1:
                            Matrizes.Sudoku_playground[0][6] = 1
                            pressionado = False
                if posicao_click_x > 620 and posicao_click_x < 690:
                    if events.type == pygame.KEYDOWN:
                        if events.key == pygame.K_1:
                            Matrizes.Sudoku_playground[0][7] = 1
                            pressionado = False
                if posicao_click_x > 690 and posicao_click_x < 760:
                    if events.type == pygame.KEYDOWN:
                        if events.key == pygame.K_1:
