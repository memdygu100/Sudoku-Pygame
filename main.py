            ...
            if (posicao_click_x > 480 and posicao_click_y > 230) and (posicao_click_x < 550 and posicao_click_y < 300):
                if events.type == pygame.KEYDOWN:
                    if events.key == pygame.K_1:
                        ...
                        pressionado = False
            if (posicao_click_x > 550 and posicao_click_y > 230) and (posicao_click_x < 620 and posicao_click_y < 300):
                if events.type == pygame.KEYDOWN:
                    if events.key == pygame.K_1:
                        Matrizes.Sudoku_playground[0][6] = 1
                        pressionado = False
            if (posicao_click_x > 610 and posicao_click_y > 230) and (posicao_click_x < 680 and posicao_click_y < 300):
                if events.type == pygame.KEYDOWN:
                    if events.key == pygame.K_1:
